...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/day13?user=root&password=1234&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("goods","Goods","day13").init();  
        new GenEntityOracle("brand","Brand","day13").init();
        new GenEntityOracle("category","Category","day13").init();
        new GenEntityOracle("cate_brand","CateBrand","day13").init();
    }  
}